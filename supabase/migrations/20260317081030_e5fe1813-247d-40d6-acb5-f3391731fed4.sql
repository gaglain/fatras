-- Fix dispatch_push_notification_on_notification_insert: pass body as jsonb, not text
...
-- Fix dispatch_push_on_email_notification_insert: pass body as jsonb, not text
...
-- Also fix dispatch_push_badge_sync_on_notification_change if it exists
