-- Corriger la fonction de création d'utilisateur pour gérer les contraintes de clé étrangère
...
BEGIN
  ...
  INSERT INTO public.user_profiles (
    ...
    CASE WHEN profile_data->>'birth_date' != '' THEN (profile_data->>'birth_date')::date ELSE NULL END,
    ...
    COALESCE(profile_data->'availability', NULL),
    COALESCE(
