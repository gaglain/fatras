            ...
            >
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  {task.due_date && (
                    <span className={`text-xs hidden sm:inline ${isOverdue ? 'text-red-600 font-medium' : 'text-muted-foreground'}`}>
              ...
              {/* Mobile: show task type and date below */}
              <div className="flex items-center gap-2 mt-1 sm:hidden pl-[52px]">
                {task.task_type && (
