...
import { Calendar, MapPin, Music, Play, Download, Phone, Mail, Instagram, Facebook, ArrowRight, Eye, Star, Menu, X } from 'lucide-react';
              ...
              <Card className="sticky top-24 rounded-2xl shadow-xl border-0">
                <div className="relative">
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    <h1 className="text-xl md:text-2xl font-bold">{selectedArtist.name}</h1>
                ...
                <CardContent className="p-4 md:p-6">
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600 text-xs md:text-sm leading-relaxed">{selectedArtist.bio}</p>
                    </div>
                    
                    <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                      <div className="text-center">
                        <div className="text-xl md:text-2xl font-bold text-purple-600">{selectedArtist.upcomingShows}</div>
                        <div className="text-xs text-gray-500">Prochains spectacles</div>
                      </div>
                      <div className="text-center">
                        <div className="text-xl md:text-2xl font-bold text-purple-600">{selectedArtist.rating}</div>
