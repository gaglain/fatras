...
const ContactLists = lazy(() => import('@/pages/ContactLists').then(module => ({ default: module.default || module.ContactLists || module })));
const Tasks = lazy(() => import('@/pages/Tasks').then(module => ({ default: module.Tasks })));
const Events = lazy(() => import('@/pages/Events').then(module => ({ default: module.Events })));
const EventTypes = lazy(() => import('@/pages/EventTypes').then(module => ({ default: module.EventTypes })));
const Agenda = lazy(() => import('@/pages/Agenda').then(module => ({ default: module.default || module.Agenda || module })));
...
const ShowBible = lazy(() => import('@/pages/ShowBible').then(module => ({ default: module.default || module.ShowBible || module })));
...
const Opportunities = lazy(() => import('@/pages/Opportunities').then(module => ({ default: module.default || module.Opportunities || module })));
