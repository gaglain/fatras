...
const EventTypes = lazy(() => import('@/pages/EventTypes').then(module => ({ default: module.default })));
const Agenda = lazy(() => import('@/pages/Agenda').then(module => ({ default: module.default })));
const Artists = lazy(() => import('@/pages/Artists').then(module => ({ default: module.default })));
...
const Forms = lazy(() => import('@/pages/Forms').then(module => ({ default: module.default })));
...
const RoadShow = lazy(() => import('@/pages/RoadShow').then(module => ({ default: module.default })));
...
const Website = lazy(() => import('@/pages/Website').then(module => ({ default: module.default })));
const UserManagement = lazy(() => import('@/pages/UserManagement').then(module => ({ default: module.default })));
const Application = lazy(() => import('@/pages/Application').then(module => ({ default: module.default })));
